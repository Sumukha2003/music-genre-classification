...
const ACCEPTED_TYPES = ['audio/mpeg', 'audio/wav', 'audio/ogg', 'audio/mp3', 'audio/x-wav'];
...
export default function AudioUploader({ onFileSelect, selectedFile, onClear, disabled }: AudioUploaderProps) {
    ...
    return (
        <div className="space-y-2">
            <div
                ...
                className={[
                    'relative flex flex-col items-center justify-center gap-4 p-10 rounded-2xl border-2 border-dashed transition-all duration-200 cursor-pointer select-none',
                    isDragging
