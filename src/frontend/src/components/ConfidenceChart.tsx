...
export default function ConfidenceChart({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: DOM-reads only; animate whenever predicted genre changes
  useEffect(() => {
  ...
  return (
    <div ref={barsRef} className="space-y-3">
      {sortedEntries.map(([genre, score]) => {
        const isPredicted =
          genre.toLowerCase() === predictedGenre.toLowerCase();
          ...
          <div
            ...
            className={[
              ...
              isPredicted
                ...
                : "bg-charcoal-800/60 border border-charcoal-700/50",
            ].join(" ")}
          >
