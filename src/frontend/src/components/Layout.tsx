          ...
          <div className="flex flex-col items-center text-center gap-4">
            ...
            <div>
              <h1 className="font-display font-bold text-3xl md:text-4xl lg:text-5xl text-foreground tracking-tight">
                Music Genre{" "}
                <span className="text-amber-500 text-amber-glow">
                  Classifier
                </span>
              </h1>
              <p className="mt-3 text-muted-foreground text-base md:text-lg max-w-xl mx-auto">
                Upload any audio file and our AI will identify its genre with
                confidence scores across 10 music categories.
              </p>
            </div>
      ...
      <footer className="border-t border-charcoal-700/50 py-6">
        <div className="container mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-muted-foreground">
          <div className="flex items-center gap-2">
            ...
            <span>
              Music Genre Classifier &copy; {new Date().getFullYear()}
            </span>
          </div>
          <a
            href={utmUrl}
